								...
								<div class="flex flex-col flex-1 pl-1">
									<div class="flex border-b border-gray-100 dark:border-gray-800 w-full">
										<input
											...
											placeholder={$i18n.t('Title (e.g. Interview warning signs)')}
											bind:value={prompt.title[0]}
										/>

										<input
											class="px-3 py-1.5 text-xs w-full bg-transparent outline-none border-r border-gray-100 dark:border-gray-800"
											placeholder={$i18n.t('Subtitle (e.g. What are some red flags to watch out for during an interview?)')}
									...
									<textarea
										...
										placeholder={$i18n.t('Prompt (e.g. Interview warning signs What are some red flags to watch out for during an interview?)')}
										rows="3"
